...
N 310 -320 340 -320 {lab=A}
N 300 -320 310 -320 {lab=A}
...
C {/foss/designs/vlsi_sky130b/design/xschem/CG4/cg4.sym} 310 -180 0 0 {name=x1 VSS=VSS VDD=VDD}
C {/foss/designs/vlsi_sky130b/design/xschem/INV/inv.sym} 370 -420 0 0 {name=x2 VSS=VSS VDD=VDD}
C {lab_pin.sym} 420 -420 2 0 {name=p2 sig_type=std_logic lab=!A}
C {devices/lab_pin.sym} 290 -420 0 0 {name=p4 sig_type=std_logic lab=A}
C {/foss/designs/vlsi_sky130b/design/xschem/INV/inv.sym} 380 -320 0 0 {name=x3 VSS=VSS VDD=VDD}
C {lab_pin.sym} 430 -320 2 0 {name=p15 sig_type=std_logic lab=!B}
