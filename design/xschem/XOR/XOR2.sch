...
C {devices/opin.sym} 40 -300 0 0 {name=p13 lab=Y
}
C {devices/lab_pin.sym} 460 -160 0 1 {name=p14 sig_type=std_logic lab=Y}
...
C {INV/inv_smol.sym} 370 -420 0 0 {name=x2 VSS=VSS VDD=VDD}
C {INV/inv_smol.sym} 380 -320 0 0 {name=x3 VSS=VSS VDD=VDD}
