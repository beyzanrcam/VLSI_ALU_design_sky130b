...
.include '../mag/NAND/NAND3/nand3_x.spice'
.control 
set color0 = white
...
C {From Layout/NAND/nand3.sym} 160 80 0 0 {name=x1 VSS=VSS VDD=VDD}
C {From Layout/NAND/nand3.sym} 160 640 0 0 {name=x11 VSS=VSS VDD=VDD}
