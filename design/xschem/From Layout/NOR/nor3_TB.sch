...
.include '../mag/NOR/NOR3/nor3_pex.spice'
.control 
set color0 = white
...
C {From Layout/NOR/nor3.sym} 160 80 0 0 {name=x1 VSS=VSS VDD=VDD}
C {From Layout/NOR/nor3.sym} 160 640 0 0 {name=x11 VSS=VSS VDD=VDD}
