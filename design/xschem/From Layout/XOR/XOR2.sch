...
C {devices/ipin.sym} 70 -360 0 0 {name=p2 lab=!A}
C {devices/ipin.sym} 70 -340 0 0 {name=p3 lab=B}
C {devices/ipin.sym} 70 -320 0 0 {name=p4 lab=!B}
C {devices/lab_pin.sym} 160 -230 0 0 {name=p5 sig_type=std_logic lab=!A}
...
C {devices/lab_pin.sym} 160 -170 0 0 {name=p8 sig_type=std_logic lab=!B}
