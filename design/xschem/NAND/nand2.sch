...
N 140 160 140 270 {lab=B}
N 110 210 140 210 {lab=B}
...
N 140 320 140 360 {lab=A}
N 140 320 270 320 {lab=A}
N 270 160 270 320 {lab=A}
...
C {devices/ipin.sym} 140 360 0 0 {name=p3 lab=A}
...
C {devices/ipin.sym} 120 210 0 0 {name=p5 lab=B}
