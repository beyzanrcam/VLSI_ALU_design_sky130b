...
C {devices/ipin.sym} -140 30 0 0 {name=p27 lab=C}
...
C {devices/ipin.sym} -140 -30 0 0 {name=p1 lab=A0}
C {devices/ipin.sym} -140 0 0 0 {name=p33 lab=B0}
C {devices/ipin.sym} -140 150 0 0 {name=p2 lab=A1}
C {devices/ipin.sym} -140 180 0 0 {name=p3 lab=B1}
C {devices/ipin.sym} -130 320 0 0 {name=p9 lab=A2}
C {devices/ipin.sym} -130 350 0 0 {name=p10 lab=B2}
C {devices/ipin.sym} -130 510 0 0 {name=p4 lab=A3}
