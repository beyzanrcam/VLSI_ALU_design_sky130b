...
N 200 -120 200 260 {lab=#net3}
N 200 260 380 260 {lab=#net3}
N 220 -280 220 220 {lab=#net7}
N 220 220 380 220 {lab=#net7}
N 180 420 180 530 {lab=#net5}
N 180 420 380 420 {lab=#net5}
N 160 370 340 370 {lab=#net4}
N 340 370 340 380 {lab=#net4}
...
N 170 40 320 40 {lab=#net2}
N 320 40 320 140 {lab=#net2}
N 320 140 380 140 {lab=#net2}
N 170 200 360 200 {lab=#net1}
