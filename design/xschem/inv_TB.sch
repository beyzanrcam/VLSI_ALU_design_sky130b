...
C {devices/lab_pin.sym} 90 -110 2 0 {name=p4 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} 40 -110 2 0 {name=p5 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 80 80 0 0 {name=p2 sig_type=std_logic lab=INPUT
}
C {devices/lab_pin.sym} 120 60 1 0 {name=p3 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 120 100 3 0 {name=p6 sig_type=std_logic lab=VSS}
