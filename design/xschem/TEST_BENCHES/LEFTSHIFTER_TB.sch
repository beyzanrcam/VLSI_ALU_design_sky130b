...
C {SHIFTER/left_shifter.sym} 10 0 0 0 {name=x1 VSS=VSS VDD=VDD}
...
C {devices/code_shown.sym} 240 -150 0 0 {name=s2 only_toplevel=false value="
...
.endc
"}
C {devices/code.sym} 285 -365 0 0 {name=TT_MODELS1
only_toplevel=true
...
"
spice_ignore=false}
C {devices/vsource.sym} 500 -310 0 0 {name=V1 value=1.2 savecurrent=false}
C {devices/vsource.sym} 550 -310 0 0 {name=V2 value=0 savecurrent=false}
C {devices/gnd.sym} 500 -280 0 0 {name=l1 lab=GND}
C {devices/gnd.sym} 550 -280 0 0 {name=l2 lab=GND}
C {devices/iopin.sym} 500 -360 3 0 {name=p28 lab=VDD
}
C {devices/iopin.sym} 550 -360 3 0 {name=p29 lab=VSS}
