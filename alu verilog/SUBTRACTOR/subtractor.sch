...
N -610 20 -610 60 {lab=#net2}
N -610 60 -150 60 {lab=#net2}
N -150 30 -150 60 {lab=#net2}
...
C {/home/efeler_gibi/Documents/vlsi/vlsi_sky130b/design/xschem/XOR/XOR2.sym} -450 30 0 0 {name=x2[7:0]}
C {devices/ipin.sym} -610 60 0 0 {name=p2 lab=K}
